...
const isEntityOfType = <T,>(entity: any, typename: string): entity is T =>
...
export const getHumanOfHeroDetailsQueryOfCharacters = (
  characters?: HeroOfHeroDetailsQuery[],
): HumanOfHeroDetailsQuery[] => {
  if (!characters) return [];
  return getEntitiesByType<HumanOfHeroDetailsQuery>(characters, 'Human');
};

export const getDroidOfHeroDetailsQueryOfCharacters = (
  characters?: HeroOfHeroDetailsQuery[],
): DroidOfHeroDetailsQuery[] => {
  if (!characters) return [];
